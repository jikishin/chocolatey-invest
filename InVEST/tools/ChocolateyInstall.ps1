...
$packageName = 'InVEST' # arbitrary name for the package, used in messages
$installerType = 'EXE' #only one of these two: exe or msi
$url = 'http://ncp-dev.stanford.edu/~dataportal/invest-releases/InVEST_2_5_6_x86_Setup.exe' # download url
$url64 = 'http://ncp-dev.stanford.edu/~dataportal/invest-releases/InVEST_2_5_6_x64_Setup.exe' # 64bit URL here or just use the same as $url
